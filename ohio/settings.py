...
GEOS_LIBRARY_PATH = '/app/.heroku/vendor/lib/libgeos_c.so' if os.environ.get('ENV') == 'HEROKU' else os.getenv('/System/Volumes/Data/usr/local/lib/libgdal.dylib')
GDAL_LIBRARY_PATH = '/app/.heroku/vendor/lib/libgdal.so' if os.environ.get('ENV') == 'HEROKU' else os.getenv('/System/Volumes/Data/usr/local/Cellar/gdal/3.4.1_1/lib/libgdal.dylib')
